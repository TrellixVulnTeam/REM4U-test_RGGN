...
Adresse_depart = input('Adresse Départ:')
Adresse_arrivée = input('Adresse Arrivée:')
...
df = pd.read_csv('D://En Cours//REM4U//tata.csv', delimiter=',',encoding='utf-8')
                ...
                for k in range(len(l1)):
                    ...
                    if l2:
                        ...
                        for n in range(len(l2)):
                            ...
                            # print(
                            #   "     ---------------------------------------------------------------------------------------------------------------------------------------------------")
                            if (l1[k][6] == Compagnie or l2[n][6] == Compagnie) and (k1 < k2):
                ...
                for k in range(len(l1)):
                    ...
                    if l2:
                        ...
                        for n in range(len(l2)):
                            ...
                            l3.insert(0, cf3.columns.to_list())

                            l3.remove(["Heurelocale", "départ_IATA", "destination_IATA",
                                        "HeureArrivé", "Prix_Camp1", "Durée_trajet", "Compagnie"])
                            if l3:
